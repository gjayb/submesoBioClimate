 function out=save_vs_core_avg(fct,filestart,filemid,fileend,path,res,z_edge,stzidx,zlevs)
global z
...
[nx,ny,nz,nt1]=size(w_z) %298 298 3 120

display('calc vort strain')
size(v_z) %298 298 3 120
size(dxrho) %300 300
size(u_z) %298 298 3 120
size(dyrho) %300 300
...
save(strcat('vs_',res,'_',filemid{fct},'_avg.mat','-v7.3'))
